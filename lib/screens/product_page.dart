...
import 'package:itsewa/widgets/image_swipe.dart';
import 'package:itsewa/widgets/product_color.dart';
...
class _ProductPageState extends State<ProductPage> {
  ...
  final SnackBar _snackBar0 = SnackBar(
                      ...
                      child: Row(
                        ...
                        children: [
                          GestureDetector(
                            onTap: () async {
                              await _addToSaved();
                              Scaffold.of(context).showSnackBar(_snackBar0);
                            },
                            child: Container(
                              width: 65.0,
                              height: 65.0,
